...
class CLIPWrapper(VLMWrapperRetrieval):
    """
    Wrapper class for the CLIP model that implements the VLMWrapperRetrieval interface.
    Provides methods for processing inputs and obtaining image and text embeddings.
    """
